...
from xtrace_sdk.x_vec.utils.xtrace_types import BFVParameters, BFVPublicKey, EncryptedVector
...
class BFVExecutionPolicy:
    ...
    def config(self) -> dict[str, Any]:
        from xtrace_sdk.x_vec.crypto.encryption.bfv import _parameter_dict
