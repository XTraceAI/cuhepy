...
enum class Phase : std::size_t {
    ...
    pointwise, scale_round, mod_q, buffers, automorphism, add_sub, wire_import, wire_export, other, count
};
inline constexpr const char* phase_names[] = {
    "forward_ntt", "inverse_ntt", "to_residues", "crt_reconstruct", "crt_exact_fallback", "gadget_decompose",
    "pointwise", "scale_round", "mod_q", "buffers", "automorphism", "add_sub", "wire_import", "wire_export", "other"
};
