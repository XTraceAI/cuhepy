...
Built on top of them, :mod:`cuhepy.hamming` is the worked application these
backends were originally written for: an evaluator holding only the public key
ranks encrypted vectors by Hamming distance without learning them. The schemes
do not depend on it.
