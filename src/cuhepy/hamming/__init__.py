...
- ``bfv_guarded`` / ``bfv_verified`` / ``bfv_attested`` / ``bfv_nitro`` — protocol
  layers that address the decryption-oracle attack described in
  ``docs/research/native-bfv-security.md``.
"""
