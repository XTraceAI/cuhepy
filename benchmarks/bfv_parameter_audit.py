...
def manifest(profile: str) -> dict[str, Any]:
    ...
    from xtrace_sdk.x_vec.crypto.encryption.bfv import _parameter_modulus, _rns_coefficient_primes
    ...
    sources = [
        "src/xtrace_sdk/x_vec/crypto/encryption/bfv.py",
        "src/xtrace_sdk/x_vec/crypto/bfv_client.py",
        "src/xtrace_sdk/x_vec/crypto/bfv_security.py",
        "src/xtrace_sdk/x_vec/crypto/bfv_assurance.py",
        "src/xtrace_sdk/x_vec/utils/xtrace_types.py",
    ]
    return {
        "schema": 1,
        "profile": profile,
